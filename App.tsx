...
// import { GluestackUIProvider, Text, AppearanceProvider, useTheme, setTheme} from '@gluestack-ui/themed';
...
//       style={[
//         styles.navItem,
//         selectedMenu === menuName && styles.selectedNavItem,
//       ]}
//       onPress={() => {
...
//         style={[
//           styles.navText,
//           selectedMenu === menuName && styles.selectedNavText,
//         ]}>
//         {menuName}
//       </Text>
//     </TouchableOpacity>
...
const App = () => {
  ...
  const themeConfig = {
    ...config,
    config: {
      initialColorMode: 'light',  // Set initial theme to light
      useSystemColorMode: false,  // Disable system-based theme switching
    },
  };
